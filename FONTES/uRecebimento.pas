...
uses
  ...
  Vcl.Imaging.pngimage, Vcl.ExtCtrls, CONTAS_RECEBER, UDM;
...
begin
  ...
  if Application.MessageBox('Deseja realmente receber essa conta?', 'ATENÇÃO', mb_iconquestion + mb_yesno) = idYes then
    ...
    End
    Else
    Application.MessageBox('Essa conta ja esta RECEBIDA!', 'ATENÇÃO', MB_ICONEXCLAMATION);
